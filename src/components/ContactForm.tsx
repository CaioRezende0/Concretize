...
import { Send, User, Mail, Phone, MessageSquare, CheckCircle, FileSpreadsheet, Sparkles } from 'lucide-react';
...
export default function ContactForm() {
  ...
  const createWhatsAppMessage = (data: LeadFormData): string => {
    ...
    const description = data.message.trim() ? data.message.trim() : 'Não informado.';

    const text = `🏗️ *Nova Solicitação de Orçamento*
...
Solicitação enviada através da Landing Page da Concretize Engenharia.`;
    ...
    return `https://wa.me/5511949673861?text=${encodeURIComponent(text)}`;
  };
          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-32">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 font-light leading-relaxed">
                Nossa equipe de engenharia está pronta para analisar seu projeto de construção, reforma comercial ou residencial, ou regularização LTA/ILPI em São Paulo. Preencha o formulário para solicitar seu orçamento de engenharia detalhado.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-[#002d5b]">Retorno em até 24 Horas</h4>
                  <p className="text-xs text-gray-400 font-light">Análise preliminar ágil efetuada por nossa equipe.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-[#002d5b]">Estudo de Viabilidade Inicial</h4>
                  <p className="text-xs text-gray-400 font-light">Levantamento técnico básico de normas construtivas sem custo.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-[#002d5b]">Atendimento em todo o Brasil</h4>
                  <p className="text-xs text-gray-400 font-light">Prontidão logística com escritórios dedicados.</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-slate-50 border border-slate-100 rounded-md flex items-center justify-between font-mono text-[10px] text-gray-400 select-none">
              <span className="flex items-center gap-1.5">
                <FileSpreadsheet className="h-4 w-4 text-[#f27a24]" /> FORM_UUID: CONC_L9_330A2
              </span>
              <span>v2.1_SSL</span>
            </div>
          </div>
              ...
              {!isSuccess ? (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <label htmlFor="name" className="text-xs font-bold text-gray-600 uppercase tracking-wider block">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    {/* Email */}
                    <div className="space-y-2">
                      <label htmlFor="email" className="text-xs font-bold text-gray-600 uppercase tracking-wider block">
                        E-mail Corporativo <span className="text-[#f27a24]">*</span>
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                    ...
                    {/* Phone */}
                    <div className="space-y-2">
                      <label htmlFor="phone" className="text-xs font-bold text-gray-600 uppercase tracking-wider block">
                        Telefone / WhatsApp <span className="text-[#f27a24]">*</span>
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="projectType" className="text-xs font-bold text-gray-600 uppercase tracking-wider block">
                    ...
                    >
                      <option value="construcao-reforma">Construção e Reforma</option>
                      <option value="regularizacao">Regularização de Imóveis</option>
                      <option value="ilpi-lta">ILPI e LTA para Casas de Repouso e outros estabelecimentos</option>
                  ...
                  {/* Message Input */}
                  <div className="space-y-2">
                    <label htmlFor="message" className="text-xs font-bold text-gray-600 uppercase tracking-wider block">
                  ...
                  >
                    <span>{isSubmitting ? 'Enviando Dados...' : 'Enviar Solicitação de Orçamento'}</span>
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-black text-[#002d5b]">Solicitação Recebida!</h3>
                    <p className="text-gray-500 font-light text-sm sm:text-base max-w-md">
                      Agradecemos o seu contato. Nosso departamento de engenharia civil já foi notificado e fará o retorno em até <span className="font-semibold text-[#f27a24]">24 horas úteis</span>.
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-emerald-50 rounded-md border border-emerald-100/60 text-emerald-800 text-xs font-mono flex items-center gap-2">
                    <Sparkles className="h-4.5 w-4.5 text-[#f27a24] shrink-0" /> PROTOCOLO_SISTEMA: #CONC-{Math.floor(100000 + Math.random() * 900000)}
                  </div>
