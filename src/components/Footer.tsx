...
import { MapPin, Phone, Mail, Linkedin, Instagram, CheckSquare, ArrowUp } from 'lucide-react';
    ...
    <footer className="bg-[#0b131f] text-slate-300 pt-20 pb-8 border-t border-slate-800 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-slate-800">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center space-x-2">
              <span className="text-2xl font-black text-white tracking-wider">CONCRETIZE</span>
              <div className="h-1.5 w-1.5 rounded-full bg-[#f27a24]" />
            </div>
            <p className="text-sm font-light leading-relaxed text-slate-400">
              Elevando os padrões da engenharia civil em São Paulo através de responsabilidade, qualidade de elite e preço justo em cada projeto.
            </p>
            <div className="text-xs text-slate-400 font-mono space-y-1">
              <p>Responsável Técnico:</p>
              <p className="text-amber-400 font-semibold">Kaique Miranda da Cruz</p>
              <p className="text-[10px] text-slate-500">Engenheiro Civil // CREA-SP</p>
            </div>
          ...
          <div className="lg:col-span-3 space-y-4">
            <h4 className="text-xs font-bold text-white uppercase tracking-widest font-mono">Legal & Técnico</h4>
            <ul className="space-y-2.5 text-sm font-light text-slate-400">
              <li>
                <a href="#contato" className="hover:text-white hover:underline transition-all">
                  Termos de Serviço
                </a>
              </li>
              <li>
          ...
          {/* Column 4: Contato */}
          <div className="lg:col-span-3 space-y-4">
            <h4 className="text-xs font-bold text-white uppercase tracking-widest font-mono">Contato</h4>
            <ul className="space-y-4 text-xs sm:text-sm font-light">
              <li className="flex items-start space-x-2.5">
                ...
                <span className="text-slate-400 leading-normal">
                  R. Catarina de Camargo, 107 - Vila Inema, Hortolândia - SP, 13185-132
                </span>
              </li>
              <li className="flex items-center space-x-2.5">
                <Phone className="h-4.5 w-4.5 text-[#f27a24] shrink-0" />
                <a href="tel:+5519982535257" className="text-slate-400 hover:text-white transition-colors">
                  +55 (19) 98253-5257
                </a>
              </li>
              <li className="flex items-center space-x-2.5">
                <Mail className="h-4.5 w-4.5 text-[#f27a24] shrink-0" />
                <a href="mailto:eng.Kaiquemiranda@gmail.com" className="text-slate-400 hover:text-white transition-colors">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-slate-500">
          <div>
            <p>© 2026 Concretize Engineering Partners. Todos os direitos reservados.</p>
            <p className="mt-1 text-slate-600">Precision in Every Detail. CRM_CREA v9.41</p>
          </div>
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-1.5 text-slate-400 bg-slate-800/40 px-3 py-1.5 rounded-sm border border-slate-800/80">
              ...
              <span className="font-bold tracking-wider uppercase text-[9px]">ISO 9001:2015 CERTIFIED</span>
            </div>
